...
def group_parameters(**kwargs):
    ...
    for key, value in kwargs.items():
        ...
        if parameter_type in parameter_groups:
            parameter_groups[parameter_type].append([key, value])
        else:
            parameter_groups[parameter_type] = [[key, value]]
...
# {
#     <class 'int'>: [['a', 34], ['c', 2]],
#     <class 'str'>: [['b', 'some text']],
#     <class 'float'>: [['d', 1.3], ['f', -3.0]],
#     <class 'dict'>: [['e', {1: 2}]]
# }
